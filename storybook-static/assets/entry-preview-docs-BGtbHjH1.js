      ...
      (function t(r) {
        ...
        function m(x) {
          var y = {},
            ...
            B;
          for (v in x)
            x.hasOwnProperty(v) && ((B = x[v]), typeof B == 'object' && B !== null ? (y[v] = m(B)) : (y[v] = B));
          return y;
        }
        function g(x, y) {
          var v, B, P, j;
      ...
      (function () {
        ...
        function o(D, E) {
          ...
          switch (D.length) {
            ...
            case 6:
              return (
                D === 'return' || D === 'typeof' || D === 'delete' || D === 'switch' || D === 'export' || D === 'import'
              );
            case 7:
        ...
        (o.prototype.applySourceMap = function (u, h, p) {
          ...
          (this._mappings.unsortedForEach(function (C) {
            ...
            u.sources.forEach(function (C) {
              ...
              D != null &&
                (p != null && (C = r.join(p, C)), g != null && (C = r.relative(g, C)), this.setSourceContent(C, D));
            }, this));
        }),
        ...
        (h.prototype.originalPositionFor = function (g) {
          ...
          if (A >= 0) {
            ...
            if (C.generatedLine === F.generatedLine) {
              ...
              D !== null &&
                ((D = this._sources.at(D)), (D = t.computeSourceURL(this.sourceRoot, D, this._sourceMapURL)));
        ...
        (m.prototype.originalPositionFor = function (g) {
          ...
          return C
            ? C.consumer.originalPositionFor({
                ...
                column:
                  F.generatedColumn -
                  (C.generatedOffset.generatedLine === F.generatedLine ? C.generatedOffset.generatedColumn - 1 : 0),
                bias: g.bias,
              })
            ...
            if (A.consumer._findSourceIndex(t.getArg(g, 'source')) !== -1) {
              ...
              if (C) {
                var D = {
                  ...
                  column:
                    C.column + (A.generatedOffset.generatedLine === C.line ? A.generatedOffset.generatedColumn - 1 : 0),
                };
                return D;
              }
            }
          ...
          for (var A = 0; A < this._sections.length; A++)
            for (var C = this._sections[A], D = C.consumer._generatedMappings, E = 0; E < D.length; E++) {
              ...
              var L = {
                ...
                generatedColumn:
                  w.generatedColumn +
                  (C.generatedOffset.generatedLine === w.generatedLine ? C.generatedOffset.generatedColumn - 1 : 0),
        ...
        (u.prototype.walk = function (h) {
          for (var p, m = 0, g = this.children.length; m < g; m++)
            ((p = this.children[m]),
              p[o]
                ? p.walk(h)
                : p !== '' && h(p, { source: this.source, line: this.line, column: this.column, name: this.name }));
        }),
...
`,
        ...
        function Ft(i, l) {
          ...
          for (a in l)
            l.hasOwnProperty(a) && ((c = l[a]), d(c) ? (d(i[a]) ? Ft(i[a], c) : (i[a] = Ft({}, c))) : (i[a] = c));
          return i;
        }
        function si(i) {
          var l, a, c, d, k;
        ...
        ((oe.prototype.generatePattern = function (i, l, a) {
          ...
          (oe.prototype.generateAssignment = function (i, l, a, c, d) {
            return (
              r.Assignment < c && (d |= U),
              le(
                [this.generateExpression(i, r.Call, d), E + a + E, this.generateExpression(l, r.Assignment, d)],
                r.Assignment,
                c
              )
            );
...
`,
        ...
        (de.canInsertSemicolon = function () {
          return (
            this.type === f.eof || this.type === f.braceR || De.test(this.input.slice(this.lastTokEnd, this.start))
          );
        }),
        ...
        (z.parseLabeledStatement = function (e, t, r, n) {
          ...
          for (
            var h = this.type.isLoop ? 'loop' : this.type === f._switch ? 'switch' : null, p = this.labels.length - 1;
            p >= 0;
            p--
          ) {
            var m = this.labels[p];
...
`
        ...
        (Ie.declareName = function (e, t, r) {
          ...
          if (t === _e) {
            ...
            for (var h = this.scopeStack.length - 1; h >= 0; --h) {
              ...
              if ((p.var.push(e), this.inModule && p.flags & Ye && delete this.undefinedExports[e], p.flags & kt))
                break;
            }
        ...
        (J.skipBlockComment = function () {
          ...
          if (
            (r === -1 && this.raise(this.pos - 2, 'Unterminated comment'), (this.pos = r + 2), this.options.locations)
          ) {
            ze.lastIndex = t;
        ...
        (J.readString = function (e) {
          for (var t = '', r = ++this.pos; ; ) {
            ...
            n === 92
              ...
              : (Ze(n, this.options.ecmaVersion >= 10) && this.raise(this.start, 'Unterminated string constant'),
                ++this.pos);
          }
    ...
    '../../node_modules/acorn-jsx/index.js'(e, t) {
      ...
      ((t.exports = function (m) {
        return (
          ...
          function (g) {
            return p(
              { allowNamespaces: m.allowNamespaces !== !1, allowNamespacedObjects: !!m.allowNamespacedObjects },
              g
            );
          }
        );
          ...
          jsx_readToken() {
            ...
            for (;;) {
              ...
              switch (B) {
                ...
                default:
                  L(B)
                    ? ((y += this.input.slice(v, this.pos)), (y += this.jsx_readNewLine(!0)), (v = this.pos))
                    : ++this.pos;
              }
            }
          }
  ...
  var s = n.reduce(function (h, p) {
    ...
    return m
      ? h.concat(
          m.map(function (g) {
            var F, A;
            return (A = (F = g.match(/[\t ]/g)) === null || F === void 0 ? void 0 : F.length) !== null && A !== void 0
              ? A
              : 0;
          })
        )
    ...
    : (t.add(e),
      Array.isArray(e)
        ...
        : Object.keys(e)
            ...
            .reduce(function (r, n) {
              return (
                n === '_owner' || (n === 'current' || t.has(e[n]) ? (r[n] = '[Circular]') : (r[n] = Er(e[n], t))),
                r
              );
            }, {}));
}
