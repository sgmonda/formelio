          ...
          const Xt = J({
              ...
              parseInfix: (e, t) => {
                ...
                return Object.assign(
                  Object.assign({ type: 'JsdocTypeGeneric', left: P(t), elements: s }, c ? { infer: !0 } : {}),
...
`
          ...
          const bn = {
            ...
            JsdocTypeObjectField: (e, t) => {
              if (typeof e.key != 'string') throw new Error('Index signatures and mapped types are not supported');
              if (e.right === void 0)
                return { type: 'RECORD_ENTRY', key: e.key, quoteStyle: L(e.meta.quote), value: null, readonly: !1 };
              let r = t(e.right);
              return (
...
function tt({ fence: n = '```' } = {}) {
  ...
  return l(function (i) {
    let p = [[]],
      u = !1;
    for (let d of i)
      (qn.test(d.tokens.description) && !u ? p.push([d]) : p[p.length - 1].push(d), (u = o(d.tokens.description, u)));
    return p;
  }, 'parseBlock');
}
l(tt, 'getParser');
